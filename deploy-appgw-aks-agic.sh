...
aks="aks-ne-kubenet-investigation-01"
application_gw_name="appgw-ne-kubenet-investigation-01"
application_gw_public_ip="pip-${application_gw_name}"
vnet_name="vnet-ne-kubenet-investigation-01"
location="northeurope" 

# Deploy resource group
az group create --name $resource_group --location $location

# Deploy AKS with AGIC ingress addon
